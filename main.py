...
ret, thresh1 = cv2.threshold(dilat, 165, 255, cv2.THRESH_BINARY) #####################################185-230
...
ret, thresh1 = cv2.threshold(shift, 130, 255, cv2.THRESH_BINARY)
copy_output = np.zeros((500, 666, 3), np.uint8)
kernel2 = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (3,3))
erode = cv2.erode(thresh1, kernel2, iterations=6)
kernel2 = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (3,3))
...
cv2.imwrite("C:/Users/Moacir/Desktop/results/20.jpg", imagem)
